...
> **目录**
>
> - [Raft 共识模块接口](#raft-共识模块接口)
> - [RSM 层接口](#rsm-层接口)
>   - [RSM ApplyMsg 结构](#rsm-applymsg-结构)
> - [服务层接口](#服务层接口)
>   - [实现 StateMachine 接口 (RSM使用)](#实现-statemachine-接口-rsm-使用)
>   - [键值读写 RPC 接口](#键值读写-rpc-接口)
>     - [Get](#get)
>     - [Put](#put)
>   - [分片迁移 RPC 接口](#分片迁移-rpc-接口)
>     - [FreezeShard](#freezeshard)
...
>   - [分片迁移错误码](#分片迁移错误码)
>   - [错误码传播路径](#错误码传播路径)
> - [Raft 内部 RPC](#raft-内部-rpc)
>   - [RequestVote](#requestvote)
>   - [AppendEntries](#appendentries)
>     - [日志条目 LogEntry](#日志条目-logentry)
...
RSM 层通过 ApplyMsg channel 从 Raft 接收已提交的日志命令或快照：
...
#### PUT 操作
![PUT RPC Errors](images/put_rpcErrs.svg)

#### GET 操作
![GET RPC Errors](images/get_rpcErrs.svg)

#### 分片迁移 操作
![SHARD MIGRATION RPC Errors](images/shardmigration_rpcErrs.svg)
