...
func NewRfsrv(tc *tester.TesterClnt, ends []*rpc.ClientEnd, grp tester.Tgid, srv int, persister *tester.Persister) []any {
...
func newRfsrv(ts Itester, ends []*rpc.ClientEnd, grp tester.Tgid, srv int, persister *tester.Persister, snapshot bool) *rfsrv {
