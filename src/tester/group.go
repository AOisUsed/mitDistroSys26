...
func newGroups(net *rpc.Network, prog string, args []string, endName string) *Groups {
...
func makeSrvGrp(net *rpc.Network, prog string, args []string, endName string, gid Tgid, n int) *ServerGrp {
	sg := &ServerGrp{
		net:       net,
		prog:      prog,
		args:      args,
